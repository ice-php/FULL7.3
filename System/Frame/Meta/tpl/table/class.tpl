...
use Program\Table\{$className};
use Program\Record\{$recordName};
...
class {$baseName} extends Table
{
    ...
    public function search(array $info)  : array
    {
		...
		//返回查询到的数据 , Result对象
		return $list->toRecords('\Program\Record\{$recordName}');
    }
