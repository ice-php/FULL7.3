...
final class Redis
{
     ...
     * 获取redis实际句柄
     */
    public static function handle(): \redis
    {
        //如果已经连接,返回连接句柄
        if (self::$handle) {
            return self::$handle;
     ...
     * @return RedisString
     */
    public static function string(string $name, ?string $value = null, int $expire = 0): RedisString
    {
        //创建String对象
    ...
    {
        static $script;
        return $script ?: ($script = new RedisScript(self::handle()));
    }
     ...
     * @return RedisJson
     */
    public static function insert(string $name, $value = null, int $expire = 0): RedisJson
    {
     ...
     * @param int $value 值 (ASCII值 0-255)
     * @param int $expire 生存期
     * @return RedisBit
     */
    public static function bit(string $name, ?int $value = null, int $expire = 0): RedisBit
    {
        $bit = new RedisBit(self::handle(), $name);
        if (!is_null($value)) {
            $bit->setRaw(chr($value), $expire);
        }
        return $bit;
    }
     ...
     * @return RedisInt
     */
    public static function int(string $name, ?int $value = null, int $expire = 0): RedisInt
    {
     ...
     * @return RedisFloat
     */
    public static function float(string $name, ?float $value = null, int $expire = 0): RedisFloat
    {
     ...
     * @return RedisHash
     */
    public static function hash(string $name, ?array $fields = null): RedisHash
    {
        //创建Hash对象
     ...
     * @return RedisList
     */
    public static function list(string $name, ?array $values = null): RedisList
    {
        //创建对象
     ...
     * @return RedisSet
     */
    public static function set(string $name, ?array $members = null): RedisSet
    {
        //创建集合对象
     ...
     */
    public static function sortedSet(string $name, ?array $kvs = null): RedisSortedSet
    {
        //创建集合对象
     ...
     * @return RedisChannel
     */
    public static function channel(string $name): RedisChannel
    {
     ...
     * @return \Iterator
     */
    public static function select(string $pattern = '*', int $count = 1000): \Iterator
    {
        $iterator = null;
        while (true) {
     ...
     * @return int
     */
    public static function hyperCount(array $hypers): int
    {
