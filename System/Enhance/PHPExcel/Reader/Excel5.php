...
//					echo '<br />';
					...
					$this->_phpSheet->getComment( $cellAddress )
													...
													->setText($this->_parseRichText($noteDetails['objTextData']['ProductX']) );
				}
			}
		}
...
//													->setAuthor( $author )
	...
	private function _readTextObject()
	{
		...
		$this->_textObjects[$this->textObjRef] = array(
				'ProductX' => substr($text["recordData"],$text["spliceOffsets"][0]+1,$cchText),
...
//			var_dump($bcBitCount);
	...
	private function _getNextToken($formulaData, $baseCell = 'A1')
	{
		...
		case 0x61:
			...
			case  48: $function = 'ProductX'; 			$args = 2;	break;
		...
		case 0x62:
			...
			case 183: $function = 'ProductX';		break;
